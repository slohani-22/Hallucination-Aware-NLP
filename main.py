...
print(f"{'System':<45} {'Exact Acc':>10} {'Inclusive Acc':>15} {'Rejection Rate':>15}")
print("-" * 90)
print(f"{'Normal LLM (GPT-2)':<45} {normal_exact_acc:>9.2f}% {normal_inclusive_acc:>14.2f}% {'N/A':>15}")
print(f"{'Hallucination-Aware LLM (GPT-2 + Pipeline)':<45} {aware_gpt2_exact_acc:>9.2f}% {aware_gpt2_inclusive_acc:>14.2f}% {aware_gpt2_rejection_rate:>14.2f}%")
print(f"{'Grounded LLM (RoBERTa + Pipeline)':<45} {aware_exact_acc:>9.2f}% {aware_inclusive_acc:>14.2f}% {aware_rejection_rate:>14.2f}%")
print("=" * 90)
